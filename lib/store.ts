...
export type Bookmark = { id:string; title:string; source:string; officialDeadline?:string; internalDeadline?:string; mode:'informational'|'troop_participation'; branchTags:string[]; status:'published'|'converted'; convertedEventId?:string; fee?:string; eligibility?:string; activityType?:string; importedBy?:string };
