...
export default function Home(){
  ...
  return <div className="stack">
    <section className="hero"><span className="badge gold">ScoutSystem 2.0 · 實測模式</span><h1>{selected?`${selected.name} ScoutSystem`:'第 1 步：連接你的旅團後台'}</h1><p>填入你的旅團資料、Google Sheet 及 Apps Script URL。登入、成員、活動等實測都會由這個後台提供。</p><div className="row"><Link className="btn primary" href="/login">登入旅團</Link><Link className="btn gold" href="/setup">🧩 小白接入教學</Link><Link className="btn" href="/downloads">下載模板</Link></div></section>
